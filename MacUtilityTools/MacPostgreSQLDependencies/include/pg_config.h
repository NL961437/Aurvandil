...
#define CONFIGURE_ARGS " '--with-icu' '--enable-debug' '--prefix=/opt/pginstaller_15.auto/server/staging_cache/osx.build' '--with-ldap' '--with-openssl' '--with-perl' '--with-python' '--with-tcl' '--with-bonjour' '--with-pam' '--enable-thread-safety' '--with-libxml' '--with-uuid=e2fs' '--with-includes=/opt/local/Current_v15/include/libxml2:/opt/local/Current_v15/include:/opt/local/Current_v15/include/security:/opt/local/Current_v15/include/openssl/' '--docdir=/opt/pginstaller_15.auto/server/staging_cache/osx.build/doc/postgresql' '--with-libxslt' '--with-libedit-preferred' '--with-gssapi' '--with-lz4' '--with-zstd' 'CFLAGS=-isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk -mmacosx-version-min=10.15 -arch x86_64 -arch arm64 -O2' 'LDFLAGS=-L/opt/local/Current_v15/lib' 'ICU_CFLAGS=-I/opt/local/Current_v15/include' 'ICU_LIBS=-L/opt/local/Current_v15/lib -licuuc -licudata -licui18n' 'XML2_CONFIG=/opt/local/Current_v15/bin/xml2-config' 'LZ4_CFLAGS=-I/opt/local/Current_v15/include' 'LZ4_LIBS=-L/opt/local/Current_v15/lib' 'ZSTD_CFLAGS=-I/opt/local/Current_v15/include' 'ZSTD_LIBS=-L/opt/local/Current_v15/lib' 'PERL=/Library/edb/languagepack/v3/Perl-5.36/bin/perl' 'PYTHON=/Library/edb/languagepack/v3/Python-3.10/bin/python3'"
...
#define PG_VERSION_STR "PostgreSQL 15.1 on x86_64-apple-darwin20.6.0, compiled by Apple clang version 12.0.0 (clang-1200.0.32.29), 64-bit"
